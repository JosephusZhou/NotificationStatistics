package top.losttime.notificationstatistics.widget.divider;
...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    protected boolean mShowReverseItem;
    ...
    protected FlexibleDividerDecoration(Builder builder) {
        ...
        mShowReverseItem = builder.mShowReverseItem;
    }
    ...
    public static class Builder<T extends Builder> {
        ...
        private boolean mShowReverseItem = false;
        ...
        public T showReverseItem() {
            mShowReverseItem = true;
            return (T) this;
        }
